...
export const Timeline = ({data, title, desc}: { data: TimelineEntry[], title: string, desc?: string }) => {
  ...
  return (
    <div
      className="w-full bg-gray-100 dark:bg-gray-800 font-sans md:px-10 rounded-xl"
      ref={containerRef}
    >
