    ...
    <footer
      ...
      <div className={"flex w-full max-w-screen-xl justify-between text-black flex-col sm:flex-row gap-4 sm:gap-0"}>
        <div className="flex flex-col">
          <h2 className="flex text-2xl font-semibold mb-4">Links</h2>
        ...
        <div className="flex flex-col">
          <h2 className="flex text-2xl font-semibold mb-4">Un projet ?</h2>
