export const Allcompetences = [
  ...
  },
  {
    ...
    competences: [
      {
        AC: "AC 31.01",
        ACtxt: "Choisir et implémenter les architectures adaptées",
        lvl: "Compris",
        Ex: "Ce projet nécessite le choix d’une architecture adaptée pour gérer à la fois le front-end et le back-end de l'application avec Symfony. Il faudra aussi choisir comment gérer la base de données pour les profils utilisateurs et comment intégrer les différentes fonctionnalités."
      },
      {
        AC: "AC 31.02",
        ACtxt: "Faire évoluer une application existante",
        lvl: "Acquis",
        Ex: "Ce projet implique non seulement de créer une application web, mais aussi de la faire évoluer, par exemple, en ajoutant de nouvelles fonctionnalités telles que la gestion des profils, la visibilité, et la possibilité de modifier les informations."
      },
      {
        AC: "AC 32.02",
        ACtxt: "Profiler, analyser et justifier le comportement d'un code existant",
        lvl: "Compris",
        Ex: "Lors du développement du projet, il sera nécessaire d'analyser les performances du code (temps de réponse des pages, gestion des requêtes à la base de données), d'optimiser le comportement des différentes fonctions, et de justifier les choix techniques (par exemple, l'utilisation de Symfony et de Twig)."
      },
      {
        AC: "AC 33.03",
        ACtxt: "Appliquer une politique de sécurité au niveau de l'infrastructure",
        lvl: "Maîtrisé",
        Ex: "Étant donné que ce projet traite des données personnelles (emails, codes de profil, etc.), il est essentiel de mettre en place des pratiques de sécurité robustes : validation des entrées, gestion des rôles utilisateurs (admin/normal), sécurisation des mots de passe, etc."
      },
      {
        AC: "AC 34.02",
        ACtxt: "Préparer et extraire les données pour l'exploitation",
        lvl: "Acquis",
        Ex: "Le projet nécessitant l'extraction de données utilisateur (par exemple, pour afficher un profil ou les envoyer au format JSON), il sera nécessaire de structurer, extraire et manipuler ces données efficacement."
      },
      {
        AC: "AC 36.01",
        ACtxt: "Organiser et partager une veille technologique et informationnelle",
        lvl: "Compris",
        Ex: "Il sera peut-être nécessaire d'organiser une veille sur les technologies utilisées (Symfony, JavaScript natif, etc.) pour rester à jour avec les bonnes pratiques et intégrer des solutions innovantes dans ce projet."
      },
    ]
  },
  {
    ...
    competences: [
      ...
      {
        AC: "AC 35.02",
        ACtxt: "Savoir intégrer un projet informatique dans le système d'information d'une organisation",
        lvl: "Compris",
        Ex: "L'intégration de l'API dans un système d'information global, y compris la gestion des utilisateurs, l'administration des événements, et l'interaction avec d'autres systèmes (par exemple, un système de gestion des paiements ou des notifications), est essentielle pour réussir ce projet."
      },
      {
        AC: "AC 36.01",
        ACtxt: "Organiser et partager une veille technologique et informationnelle",
