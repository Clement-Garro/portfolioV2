export const en = {
  ...
  about: {
    ...
    whatILike: "Interests",
    whatILikeText1: "My passion for technology naturally led me to computer science, from building hardware configurations to mastering multiple programming languages. In parallel, I cultivate a strong interest in Japanese culture, video games, and sports, which nurture my creativity and open-mindedness. Cooking also represents a creative outlet where I enjoy experimenting and discovering new flavors.",
